import { ChevronRight, MonitorPlay, BarChart3, Users } from "lucide-react";
...
const PienaLandingPage = () => {
  return (
    <div className="min-h-screen flex justify-center relative overflow-hidden flex-col">
      <Navbar />
        ...
        <main>
          ...
          <section className="container mx-auto px-6 py-16 text-center">
            <h2 className="text-4xl font-bold mb-4">
              Revolutionize Your Advertising with Transparent LED Screens
            </h2>
            <p className="text-xl mb-8">
              Connect advertisers and brands through a powerful marketplace for
              premium ad space
            </p>
          ...
          <section className="bg-blue-600 text-white py-16">
            <div className="container mx-auto px-6 text-center">
              ...
              <p className="text-xl mb-8">
                Join PIENA CRM/CMS today and unlock the power of transparent LED
                advertising
              </p>
              <a
                href="#"
